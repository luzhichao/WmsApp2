                ...
                for(var i=0;i<collapseHeader.length;i++){
                    (function(e){
                        collapseHeader[e].onclick = function(){
                            if(collapseHeader[e].nextElementSibling.className.indexOf("aui-collapse-content") > -1){
                                if(collapseHeader[e].nextElementSibling.className.indexOf("aui-show") > -1){
                                    collapseHeader[e].nextElementSibling.classList.remove("aui-show");
                                    ...
                                    collapseHeader[e].nextElementSibling.classList.toggle("aui-show");
