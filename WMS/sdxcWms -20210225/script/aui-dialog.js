    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                if(params.mutiple){
                	msgHtml = '<div class="aui-dialog-body"><textarea placeholder="'+params.text+'" autofocus/></div>';
                }else{
                	msgHtml = '<div class="aui-dialog-body"><input type="text" placeholder="'+params.text+'" autofocus></div>';
                }
                if (params.value) {
                    msgHtml = '<div class="aui-dialog-body"><input type="number" value="'+params.value+'" autofocus></div>';
                }else{
                    msgHtml = '<div class="aui-dialog-body"><input type="number" id="dialog_input_number" autofocus></div>';
                }
            }else{
                        ...
                        if(callback){
                            if(params.input){
                                callback({
                                    ...
                                    text: params.mutiple?document.querySelector(".aui-dialog-body textarea").value:document.querySelector(".aui-dialog-body input").value
                                });
                            }else{
                                callback({
                                    buttonIndex: parseInt(this.getAttribute("button-index"))+1
