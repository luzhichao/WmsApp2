...
public class BaseEaseChatFragment extends EaseBaseFragment implements EMMessageListener {
...
//    static final int ITEM_LOCATION = 3;
    ...
    protected int[] itemStrings = {  com.hyphenate.easeui.R.string.attach_picture};
    protected int[] itemdrawables = {com.hyphenate.easeui.R.drawable.ease_chat_image_selector };
...
//        messageList.setAvatarShape(1);
        ...
        kickedForOfflineLayout = getView().findViewById(com.hyphenate.easeui.R.id.layout_alert_kicked_off);
