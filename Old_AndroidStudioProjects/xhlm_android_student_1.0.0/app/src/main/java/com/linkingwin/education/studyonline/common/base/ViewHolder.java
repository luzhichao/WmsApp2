...
import com.linkingwin.education.studyonline.common.base.view.GlideImageView;
...
public class ViewHolder {
    ...
    public ImageView getImageView(int imageViewId) {
        return (ImageView) getView(imageViewId);
    }

    public GlideImageView getGlideImageView(int imageViewId) {
        return new GlideImageView(getImageView(imageViewId));
    }


    public CheckBox getCheckBox(int checkboxViewId) {
        return getView(checkboxViewId);
    }

    public QMUIRoundButton getQMUIRoundButton(int buttonViewId) {
        return getView(buttonViewId);
    }
