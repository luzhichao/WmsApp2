...
public class Https {
     ...
     * @param callback 回调函数
     */
    public static <T> void request(HttpMethod method, String uri, MediaType mediaType, Map<String, String> headers, Map<String, Object> params, final DefaultHttpCallback callback) {
